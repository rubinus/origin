...
func Hello(ctx iris.Context) {
	...
	_, err := zgo.Redis.Set(cotx, "origin_"+name, s)
	if err != nil {
		zgo.Log.Error(err)
		return
	}
	...
	val, err := zgo.Redis.Get(cotx, "origin_"+name)
	...
	//	panic(err)
	//}
	//n.Producer(cotx, "origin", []byte("nsq888888"))
	//
	////发送到kafka
	...
	//	panic(err)
	//}
	//k.Producer(cotx, "origin", []byte("kafka9999999999"))
