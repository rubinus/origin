...
func Hello(ctx iris.Context) {
	...
	_, err := zgo.Redis.Set(cotx, "visource_"+name, s)
	if err != nil {
		zgo.Log.Error(err)
		return
	}
	...
	val, err := zgo.Redis.Get(cotx, "visource_"+name)
	...
	//	panic(err)
	//}
	//n.Producer(cotx, "visource", []byte("nsq888888"))
	//
	////发送到kafka
	...
	//	panic(err)
	//}
	//k.Producer(cotx, "visource", []byte("kafka9999999999"))
